  ...
  render(){
    return(
      <div>
        ...
        <PhoneBreakpoint>
          <div id="MyProjectCollection" style={{height:"700px",paddingBottom: "30%",backgroundColor: "white"}}>
            <h1 style={{fontFamily:"Arial",textAlign:"center",marginTop:"5%",position:"relative"}}>
              <span ref={span => this.MyProjectsCollectionArray[0] = span}>My </span>
              <span ref={span => this.MyProjectsCollectionArray[1] = span}>Projects </span>
              <span ref={span => this.MyProjectsCollectionArray[2] = span}>Collection </span>
            </h1>
            <div id="ProjectsContainer" style={{...ProjectsContainerStyle,marginTop:"2%"}}>
                <div id="1st Row" style={{...RowStyle}}>
                  {/*There are 2 columns here*/}
